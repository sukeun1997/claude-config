...
You have a persistent Persistent Agent Memory directory at `/Users/sukeunpark/.claude/agent-memory/test-code-generator/`. Its contents persist across conversations.
