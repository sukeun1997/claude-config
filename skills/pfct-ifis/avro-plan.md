---
name: avro-plan
description: "Avro 이벤트의 JSON→Glue 전환 SPIKE 분석을 수행하고 Notion 페이지에 작성합니다. 이벤트명과 소비자 정보를 입력받아 발행 현황, 소비자 영향, 멱등성, 스키마 차이, 이관 전략을 체계적으로 분석합니다."
triggers:
  - "avro plan"
  - "avro 분석"
  - "glue 전환 분석"
...
#### 1-A. InAPI 이벤트 정의 — `/Users/sukeunpark/IdeaProjects/inapi` 에서:
- JSON 이벤트 클래스 (필드 목록)
- Glue 이벤트 스키마 (필드 목록)
...
#### 1-B. banking-loan 현황 — `/Users/sukeunpark/IdeaProjects/banking-loan` 에서:
...
- InAPI 프로젝트: `/Users/sukeunpark/IdeaProjects/inapi`
- Banking-loan 프로젝트: `/Users/sukeunpark/IdeaProjects/banking-loan`
- Banking-report 프로젝트: `/Users/sukeunpark/IdeaProjects/banking-report`
- Investment 프로젝트: `/Users/sukeunpark/IdeaProjects/investment`
